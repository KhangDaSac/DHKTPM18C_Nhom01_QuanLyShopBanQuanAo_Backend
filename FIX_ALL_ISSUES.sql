-- ============================================
-- FIX TRIỆT ĐỂ TẤT CẢ VẤN ĐỀ
-- ============================================
-- Chạy script này để fix:
-- 1. Tạo Customer cho users thiếu (fix lỗi phiên đăng nhập)
-- 2. Cập nhật ảnh sản phẩm thật (fix lỗi không hiện ảnh)
-- ============================================

-- BƯỚC 1: Tạo Customer cho tất cả Users hiện có chưa có Customer
-- (Fix lỗi: "Phiên đăng nhập không hợp lệ. Vui lòng đăng nhập lại")
...
-- BƯỚC 2: Xóa ảnh giả cũ
DELETE FROM product_image;

-- BƯỚC 3: Thêm ảnh thật cho các sản phẩm
...
-- Product 16: Quần Short Kaki Nam (Đen)
(46, 16, NULL, 'https://images.unsplash.com/photo-1591195851653-45e5c90e7f47?w=500'),
(47, 16, NULL, 'https://images.unsplash.com/photo-1565084888279-aca607ecce0c?w=500'),
(48, 16, NULL, 'https://images.unsplash.com/photo-1555689502-c4b22d76c56f?w=500'),

-- Product 17: Áo Thun Nữ Basic (Trắng)
(49, 17, NULL, 'https://images.unsplash.com/photo-1618354691792-d1d42acfd864?w=500'),
(50, 17, NULL, 'https://images.unsplash.com/photo-1562157873-818bc0726f68?w=500'),
(51, 17, NULL, 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500'),

-- Product 18: Áo Thun Nữ Croptop (Đen)
(52, 18, NULL, 'https://images.unsplash.com/photo-1583744946564-b52ac1c389c8?w=500'),
(53, 18, NULL, 'https://images.unsplash.com/photo-1562157873-818bc0726f68?w=500'),
(54, 18, NULL, 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=500'),

-- Product 19: Áo Sơ Mi Nữ (Trắng)
(55, 19, NULL, 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=500'),
(56, 19, NULL, 'https://images.unsplash.com/photo-1624206112431-00beaca99a01?w=500'),
(57, 19, NULL, 'https://images.unsplash.com/photo-1624206112431-00beaca99a01?w=500'),

-- Product 20: Đầm Nữ Maxi (Hồng)
(58, 20, NULL, 'https://images.unsplash.com/photo-1612336307429-8a898d10e223?w=500'),
(59, 20, NULL, 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500'),
(60, 20, NULL, 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=500');

-- ============================================
-- VERIFICATION: Kiểm tra kết quả
-- ============================================

-- 1. Kiểm tra Customer đã được tạo
SELECT 
    u.id, 
    u.username, 
    c.user_id as has_customer,
    GROUP_CONCAT(r.name) as roles
FROM users u
LEFT JOIN customers c ON u.id = c.user_id
LEFT JOIN user_role ur ON u.id = ur.user_id
LEFT JOIN roles r ON ur.role_id = r.id
GROUP BY u.id, u.username, c.user_id
ORDER BY u.id;

-- 2. Kiểm tra ảnh sản phẩm
SELECT 
    p.id, 
    p.name, 
